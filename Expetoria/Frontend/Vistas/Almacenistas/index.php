...
include '../../../Backend/modelo/almacenista/almacenista_model.php';
        ...
        <div class="row">
            ...
            <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-md-4">
                ...
                <div class="container  border-top border-primary " style="max-width: 500px" id="contenedor-formulario">
                    ...
                    <?php
                    include "../../../../Expetoria/Frontend/Vistas/Almacenista/create.php";
                    include "../../../../Expetoria/Frontend/Vistas/Almacenista/edit.php";
                   
                    include "../../../../Expetoria/Frontend/Vistas/Almacenista/show.php";
                   
                    include "../../../../Expetoria/Frontend/Vistas/Almacenista/data.php";
                    ?>
            </main>
        </div>
    </div>
