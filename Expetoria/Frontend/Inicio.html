    ...
    <body id="page-top" background="./Imagenes/F1.jpg">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3"  id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="../Frontend/presentacion.html">LACT</a>
                <button class="navbar-toggler navbar-toggler-right" type="button" data-bs-toggle="collapse" data-bs-target="#navbarResponsive" aria-controls="navbarResponsive" aria-expanded="false" aria-label="Toggle navigation"><span class="navbar-toggler-icon"></span></button>
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="navbar-nav ms-auto my-2 my-lg-0"> 
                        <li class="nav-item"><a class="nav-link" href="./Vistas/clientes/publico/RC.php">Registro para Cliente</a></li>
                        <li class="nav-item"><a class="nav-link" href="./Vistas/productos/publico/Lacteos_Productos.html">Productos</a></li>
                ...
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">
                            Necesitas productos lacteos de calidad, en la empresa LACT te vendemos a buen precio distribuidor.
                        </h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">Bienvenido a LACT la empresa numero 1 en la distribucion de productos lacteos.
                        </p>
                        <footer>
