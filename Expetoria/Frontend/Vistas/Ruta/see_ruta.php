...
<body>
  ...
  <div class="container-fluid">
    <div class="row">
      ...
      <h1 class="h2">REGISTRO DE RUTAS</h1>   
    </div> 
      </div> 
    ...
    <div class="alert alert-danger" role="alert">
      Ruta no creada. Por favor intentelo mas tarde o contacte con su administrador.
    </div>
    <?php
      break;
    }
