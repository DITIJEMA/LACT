    ...
    <body id="page-top" background="./Imagenes/F1.jpg">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3"  id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="../Frontend/presentacion.php">LACT</a>
                ...
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h2 class="text-white font-weight-bold">
                            ...
                            encuentranos de nuestras sucursales
                        </h2>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">Bienvenido a LACT la empresa numero 1 en la distribucion de productos lacteos en el estado
                            de Jalisco y de México
                        </p>
                        <center><img src="../Frontend/Imagenes/fondos/vaquita.png" alt="" height="150" width="200"></center>
                        <footer>
